  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        {
          type: 'docSidebar',
          sidebarId: 'tutorialSidebar', // We will update this sidebar in sidebars.ts
          position: 'left',
          label: 'Book',
        },
        {to: '/blog', label: 'Blog', position: 'left', className: 'navbar-item-blog-hidden'}, // Hide blog for now
        {
          href: 'https://github.com/NimraRasheed37/hackathon1-Physical-AI-Humanoid-Robotics-book-by-nimra',
          label: 'GitHub',
          position: 'right',
        },
      ],
