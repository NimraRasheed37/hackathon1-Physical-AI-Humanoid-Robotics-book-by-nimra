...
const config: Config = {
  ...
  url: 'https://hackathon1-physical-ai-humanoid-rob-delta.vercel.app/',
  ...
  organizationName: 'nimra-rasheed', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/nimra-mehmood/AI-textbook/tree/main/',
        },
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      logo: {
        ...
        src: 'img/logo.svg',
        href: '/module-1-ros2/chapter-1-ros2-fundamentals',
      },
      items: [
        {
          type: 'docSidebar',
        ...
        {
          href: 'https://github.com/nimra-mehmood/AI-textbook',
          label: 'GitHub',
          position: 'right',
        },
      ],
